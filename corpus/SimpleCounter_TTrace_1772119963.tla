---- MODULE SimpleCounter_TTrace_1772119963 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("SimpleCounter_TTrace_1772119963.json", _TETrace)
...
\*
\*trace == IODeserialize("SimpleCounter_TTrace_1772119963.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG SimpleCounter_TTrace_1772119963 ----
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Feb 26 07:32:44 PST 2026